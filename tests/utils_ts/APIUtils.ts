export class APIUtils
{
    ...
    async createOrder(orderPayLoad: string) //mark method as async since await is used inside
    {
        let response = {token: String, orderId: String}; //object to hold token and orderId
